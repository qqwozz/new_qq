...
const t: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    edu2Meta: '2022 — н.в.',
    edu2d: 'Яндекс Лицей · IT Школа Samsung · Version Control with Git (Coursera, Atlassian) · Programming with Google Go (Coursera, UC Irvine) · Grokking System Design Interview (Educative)',
  ...
  en: {
    ...
    edu2d: 'Yandex Lyceum · IT School Samsung · Version Control with Git (Coursera, Atlassian) · Programming with Google Go (Coursera, UC Irvine) · Grokking System Design Interview (Educative)',
