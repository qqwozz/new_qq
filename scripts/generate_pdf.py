...
def generate():
    ...
    y = job(c, y,
        ...
        [
            "Разработал микросервис обработки платёжных операций — 500+ транзакций/мин",
            "Реализовал REST API для интеграции с 4 внутренними системами банка, uptime 99.9%",
            "Спроектировал схемы PostgreSQL, оптимизировал запросы — снижение latency на 30%",
            "Настроил CI/CD и Docker, время деплоя сокращено с 40 до 5 минут",
        ]
    )
